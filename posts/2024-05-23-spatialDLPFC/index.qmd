...
This analysis used many elements of the data from the spatialLIBD project, and is just one example of how this dataset is relevant to the study of disease, for example we also checked for enrichment of depression and PTSD related genes between the spatial domains. Lots of exciting applications for the study of diseases with spatial and single cell, stay tuned to future work from LIBD for more! 👀
...
For more details be sure to check out the recently published paper in Science 🎉<https://doi.org/10.1126/science.adh1938>

## Data Availability 

The 30 DLPFC Visium samples & the 56k nuclei snRNA-seq dataset are available to explore on our interactive websites and Bioconductor/R pacakge: <https://research.libd.org/spatialDLPFC/>
